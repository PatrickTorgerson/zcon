...
pub const PRADIUS_EXTENSION_INIT = fn () callconv(@import("std").os.windows.WINAPI) u32;

pub const PRADIUS_EXTENSION_TERM = fn () callconv(@import("std").os.windows.WINAPI) void;
