...
pub const PWLDP_RESETWCOSPRODUCTIONCONFIGURATION_API = fn () callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const PWLDP_ISPRODUCTIONCONFIGURATION_API = fn (
    IsProductionConfiguration: ?*BOOL,
) callconv(@import("std").os.windows.WINAPI) HRESULT;

pub const PWLDP_RESETPRODUCTIONCONFIGURATION_API = fn () callconv(@import("std").os.windows.WINAPI) HRESULT;
