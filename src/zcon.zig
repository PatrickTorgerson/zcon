...
///
pub fn write_at(pos: in.Position, str: []const u8) void {
    set_cursor(pos);
    write(str);
}

///
pub fn print_at(pos: in.Position, comptime fmt: []const u8, args: anytype) void {
    set_cursor(pos);
    print(fmt, args);
}
